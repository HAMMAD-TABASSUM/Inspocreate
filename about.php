    ...
    <div class="w-full bg-white">
        <div class="custom-container flex justify-between py-2 items-center">
            ...
            <div class="border-2 flex w-56 h-9 rounded h-10">
                <input class="w-full text-xs pl-4 roboto outline-none" type="text" placeholder="Try Women Empowerment">
            ...
            <div>
                <div class="relative">
                    ...
                    <div id="sortboxmenu"
                        ...
                        <ul class="block p-3">
                            <li><a href="profile.html" class="block px-3 py-2 hover:bg-gray-300 roboto">Profile</a></li>
                            <li><a href="settings.html" class="block px-3 py-2 hover:bg-gray-300 roboto">Settings</a>
                            </li>
                            <li><a href="logout.php" class="block px-3 py-2 hover:bg-gray-300 roboto">Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full pt-14 pb-60">
        <div class="custom-container flex flex-col items-center justify-center">
            <div>
                ...
                <ul class="flex justify-center gap-x-12 pt-10 pb-28">
                    <li>
                        <a class="flex-col" href="about.php">
                            <span class="text-2xl roboto font-medium">About You</span>
                            <img class="w-28 pt-3.5" src="assets/icons/border.svg" alt="">
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="flex-col" href="follow.php">
                            <span class="text-2xl text-gray-500 font-light roboto">You Should Follow</span>
                            <img class="opacity-0" src="assets/icons/border.svg" alt="">
                        </a>
                    </li>
                </ul>
            ...
            <form action="" method="post" enctype="multipart/form-data" class="border w-8/12 rounded p-7 relative">
                ...
                <div  class="absolute -top-14 left-80">
                    <div class="relative">
                        <img src="assets/icons/avatar.svg" id="profileDisplay" class="h-28 w-28 rounded-full"  alt="" >
                        <input class="absolute top-0 right-0 font-light text-gray-500 text-sm opacity-0 outline-none bg-white cursor-pointer min-w-full min-h-full block w-px" type="file" name="profileImage" onchange="displayImage(this)" id="profileImage">
                    </div>
                    <img class="w-8 absolute bottom-0 right-0" src="assets/icons/cam.svg" alt="">
                </div>

                <h1 class="text-center text-xs text-gray-500 pb-9 pt-10 roboto mr-5">Upload Profile Picture</h1>

                <div class="flex justify-between pb-4">
                    <h1 class="text-base roboto">Tell Us About You</h1>
                    <h1 class="text-xs roboto">Max 500 Character</h1>
                </div>

                <textarea class="text-sm border rounded p-4 text-gray-500 w-full roboto outline-none" name="bio" cols="30" rows="10" placeholder="about you"></textarea>

                <p class="text-base pt-6 pb-4 roboto">Do You Have Any Website or Blog?</p>

                <div class="flex justify-between pb-7">
                    <div>
                        <input class="border rounded w-80 p-4" name="blog" type="url" placeholder="url://">
                    </div>

                    <div>
                        <button  type="submit" name="save-user" 
                            class="bg-violet-500 hover:bg-violet-400 active:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 text-white py-4 px-16 rounded">I
                            am Excited, Take me to Next Step
                        </button>
                    </div>
                </div>
                <div class="text-right text-xs cursor-pointer"><a href="intrest.php">Skip for now</a></div>
            </form>
        </div>
    </div>
