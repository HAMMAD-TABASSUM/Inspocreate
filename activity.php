        ...
        <div class="custom-container">
            <div class="relative custom-container">
                ...
                <div class="tags relative" >
                    <aside>
                        <label data-post-id="<?php echo $row['tital']; ?>" onclick="getPostsFromTitle(event)">
                            <input class="hidden" type="checkbox" name="tags" value="<?php echo $row['tital']; ?>">
    ...
    <div class="w-full pb-36">
        <div class="custom-container flex gap-x-7">
            <div class="w-4/6 pt-20 flex flex-col gap-y-10" id="posts_list">
                ...
                <div class="border rounded-2xl" data-id="<?php echo $row['id']; ?>">
                    <div class="flex items-center justify-center">
                        <div class="bg-white rounded-2xl">
                            <div class="flex justify-between items-center p-5">
                                ...
                                <div>
                                    <span class="text-gray-400 text-sm font-light roboto" id="momentt">2 minutes ago</span>
                                </div>
                            </div>
                            <div class="relative">
                                <video controls class="w-full height object-cover" src="images/<?php echo $row['post_video']; ?>" alt="" ></video>
                                <img class="absolute play w-20 top-7 left-7" src="assets/icons/play.svg" alt="">
                            </div>
                            <div class="p-5">
        ...
        <div class="border rounded-2xl post-section" data-id="<?php echo $row['id']; ?>">
            <div class="flex items-center justify-center">
                <div class="bg-white rounded-2xl w-full">
                    ...
                    <div class="p-5">
                        <div class="border-b pb-3">
                            <h1 class="text-xl font-medium pb-1.5 roboto"><?php echo $row['tital']; ?></h1>
                                <p class="text-gray-500 text-sm roboto"><?php echo $row['discription']; ?></p>
                        </div>
                        <div class="flex pt-5">
