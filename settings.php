...
$select = "SELECT * from users where id={$usid}";
...
if(isset($_POST['save-user'])){
    ...
    $nlname = $_POST['nlname'];
    $newpass = md5($new);
    $currentPasswordHash = md5($current);
    $update = "UPDATE users set fname = '$nfname', lname = '$nlname' where id={$usid}";
    $query1 = mysqli_query($conn,$update);
    if($currentPasswordHash == $oldpwd){
        $update = "UPDATE users set password = '$newpass' where id={$usid} AND email = '$email'";
        $query1 = mysqli_query($conn,$update);
        if($query1){
            echo "your password changed sucessfull";
        }else{
            echo "your password wrong";
        }
    }else{
        // echo "Yoy Entered wrong password";
    }
}
?>
<!DOCTYPE html>
                            ...
                            <div class="px-14">
                                ...
                                <div class=" pt-6 pb-8">
                                    <ul class="flex justify-center gap-x-11">
                                        <li id="video" class=" cursor-pointer actives select-video">
                                ...
                                <div class="videos">
                                    <div class="flex gap-x-9">
                                        ...
                                        <div id=""
                                            class="videos-post select-video-actives flex justify-center items-center cursor-pointer">
                                        ...
                                        <div id=""
                                            class="url-post select-url-actives flex justify-center items-center cursor-pointer">
                                ...
                                <div class="images d-none">
                                    <div class="flex gap-x-9">
                                        ...
                                        <div
                                            class="image-posts select-video-actives flex justify-center items-center cursor-pointer">
                                        ...
                                        <div class="image-url-posts select-url-actives flex justify-center items-center cursor-pointer">
        ...
        <div class="custom-container flex flex-col items-center justify-center">
            <div class="pb-12">
                ...
                <ul class="flex justify-center gap-x-9 pt-10">
                    <li>
                        <a class="flex-col" href="about.html">
                            <span class=" text-2xl roboto font-medium">Account</span>
                    ...
                    <li>
                        <a class="flex-col" href="intrests.php">
                            <span class="text-2xl text-gray-500 font-light roboto">Interests</span>
                        </a>
                    </li>
            ...
            <form action="" method="post" enctype="multipart/form-data" class="border w-8/12 rounded p-7 relative">
                <div class="relative">

                    <?php foreach($users as $user): ?>
                        <img class="w-28 h-28 absolute avataar rounded-full relative" id="profileDisplay" src="images/<?php echo $user['profile_image']; ?>" alt="">
                    <?php endforeach; ?>
                    <input class="absolute -top-16 right-72 font-light text-gray-500 text-sm opacity-0 outline-none bg-white cursor-pointer w-28 h-28" type="file" name="profileImage" onchange="displayImage(this)" id="profileImage">
                </div>
                <img class="w-9 absolute cam" src="assets/icons/cam.svg" alt="">
                <div class="flex justify-between">
                    <div class="flex flex-col">
                        <label class="text-base pb-4 roboto" for="">First Name</label>
                        <input class="border pl-4 py-4 rounded outline-0 w-80" type="text" name="nfname"
                            placeholder="Hammad">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-base pb-4 roboto" for="">Last Name</label>
                        <input class="border pl-4 py-4 rounded outline-0 w-80" type="text" name="nlname"
                            placeholder="Tabassum">
                    </div>
                </div>

                <!-- <div class="flex flex-col pt-6">
                    <label class="text-base pb-4 roboto" for="">username</label>
                    <input class="border pl-4 py-4 rounded outline-0" type="text"
                        placeholder="hammadtabassum">
                </div> -->

                <div class="flex flex-col pt-6">
                    <label class="text-base pb-4 roboto" for="">Enter Bio</label>
                    <textarea class="border rounded outline-0 p-4" placeholder="xyz" name="bio" id=""
                        cols="30" rows="6"></textarea>
                </div>

                <div class="flex justify-between pt-6">
                    <div class="flex flex-col">
                        <label class="text-base pb-4 roboto" for="">Email Address</label>
                        <input class="border pl-4 py-4 rounded outline-0 w-80" type="email" name="email"
                            placeholder="hammad@websitename.com">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-base pb-4 roboto" for="">Website</label>
                        <input class="border pl-4 py-4 rounded outline-0 w-80" type="url" name="blog"
                            placeholder="http://">
                    </div>
                </div>
                ...
                <div class="flex justify-between pt-6">
                    <div class="flex flex-col">
                        <label class="text-base pb-4" for="">Current Password</label>
                        <input class="border pl-4 py-4 rounded outline-0 w-80" type="text" name="cpassword"
                            placeholder="Enter Current Password">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-base pb-4" for="">New Password</label>
                        <input onkeyup="triger()" class="input border pl-4 py-4 rounded outline-0 w-80" type="password" name="npassword"
                            placeholder="**********">
                    </div>
                </div>
                <div class="flex gap-5 justify-end pt-4 indicator">
                    <div class="w-16 h-1.5 bg-orange-100 rounded weak"></div>
                    <div class="w-16 h-1.5 bg-orange-100 rounded medium"></div>
                    <div class="w-16 h-1.5 bg-orange-100 rounded strong"></div>
                    <div class="w-16 h-1.5 bg-orange-100 rounded strongest"></div>
                </div>

                <div class="flex justify-between pt-6">
                    <div>
                        <button type="submit" name="save-user" class="bg-violet-500 hover:bg-violet-400 active:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 text-white py-5 px-28 roboto">Save Settings</button>
                    </div>
                    <div class="cursor-pointer flex items-center">
                        <div><img class="w-3.5" src="assets/icons/delete.svg" alt=""></div>
                        <p class="text-xs pl-4 roboto">Delete Account</p>
                    </div>
                </div>
            </form>
        </div>
