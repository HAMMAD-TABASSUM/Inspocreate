...
<head>
    ...
    <link rel="stylesheet" href="assets/css/intrest.css">
</head>
...
<body class="bg-gray-50">
                                        ...
                                        <div class="flex flex-col gap-y-6 pt-6">
                                            ...
                                            <div class="flex flex-col gap-y-2">
                                                ...
                                                <div class="h-12 w-full border rounded h-10 flex gap-x-5 p-2.5">
                                                    ...
                                                    <div class="flex items-center rounded bg-zinc-200 p-2.5">
                                                        <span class="roboto text-sm pr-2">Laptop</span>
                                                        <img class="cursor-pointer" src="assets/icons/close-tag.svg"
                                                            alt="">
                                                    </div>
                                                </div>
    ...
    <div class="w-full pt-14 pb-96">
        <div class="custom-container flex flex-col items-center justify-center">
            <div>
                ...
                <ul class="flex justify-center gap-x-12 pt-10">
                    <li>
                    ...
                    <li>
                        <a class="flex-col" href="intrest.php">
                            <span class="text-2xl roboto font-medium">Your Interest</span>
                            <img class="w-36 pt-3.5" src="assets/icons/border.svg" alt="">
                        </a>
                    </li>
            ...
            <h1 class="text-center text-2xl font-medium roboto pt-16 pb-6">Tell Us What are Your Goals</h1>
            ...
            <form action="chackbox.php" method="post" enctype="multipart/form-data" class="border w-8/12 rounded p-7 text-center">
                ...
                <div class="pt-16 pb-7">
                    <button  type="submit" name="submit" class="bg-violet-500 hover:bg-violet-400 active:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 text-white text-base py-4 px-16 rounded">Just One More Step, Yes Continue
                    </button>
                </div>
                <div class="text-center text-xs cursor-pointer"><a href="follow.php">Skip for now</a></div>
            </form>
        </div>
    </div>
    ...
    <script src="assets/js/intrest.js"></script>
</body>
